...
function Select<TValue extends string | number>({
  ...props
}: React.ComponentProps<typeof SelectPrimitive.Root> & { value?: TValue }) {
...
/* =========================
   Select Item
   ========================= */
function SelectItem<TValue extends string | number>({
  className,
  children,
  ...props
}: React.ComponentProps<typeof SelectPrimitive.Item> & { value: TValue }) {
  return (
    <SelectPrimitive.Item
      className={cn(
